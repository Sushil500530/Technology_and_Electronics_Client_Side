...
const Footer = () => {
    return (
        <div className="bg-black text-white">
            <div className=" p-5 container mx-auto text-base-content w-full h-auto lg:h-[50vh] flex flex-col items-start justify-center  mt-12">
                <footer className="grid grid-cols-1 w-full md:grid-cols-2 lg:grid-cols-4 gap-8 items-center justify-between py-12">
                    <div className="w-full lg:m-0 mx-auto flex space-y-5 flex-col items-center justify-center pt-10">
