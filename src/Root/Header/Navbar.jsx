            ...
            <div className="navbar bg-transparent">
                <div className="navbar-start">
                    <div className="dropdown w-">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 font-semibold text-[18px] z-[1] p-2 shadow text-green-500 bg-base-100 rounded-box w-52 flex flex-col items-center gap-3 ml-3 py-8 ">
                            {navLinks}
                        </ul>
                    </div>
                    <Link to="/">
                ...
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal font-semibold text-[18px] px-1 flex items-center gap-8 text-green-500">
                        {navLinks}
                    </ul>
                </div>
